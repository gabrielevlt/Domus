...
public class Server {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(" > Remote object exported successfully on port: "+exportingPort);
			
			// CREATING REGISTRY FOR THE SERVICE
			Registry registry=LocateRegistry.createRegistry(bindingPort);
			//Registry registry=LocateRegistry.getRegistry();
			
			System.out.println(" > Service's registry created successfully on port: "+bindingPort);
			
			// BINDING SERVICE AND STUB TO THE REGISTRY
			registry.rebind(serviceName, remoteObjectStub);
			
			System.out.println(" > Service and remote object bound to the registry successfully");
